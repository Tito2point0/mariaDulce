        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="space-y-4">
                {Object.entries(project.details).map(([key, value]) => (
                  key !== 'Acerca' && key !== 'Diseño' && (
                    <div key={key} className="border-b border-neutral-200 pb-2">
                      <span className="font-semibold text-neutral-600">{key}_</span>
              ...
              <div className="md:col-span-2">
                <h3 className="text-xl font-semibold text-neutral-900 mb-4">Acerca de_</h3>
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-neutral-900">Diseño_</h3>
